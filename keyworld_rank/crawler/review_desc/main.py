...
class GPlayLogin(object):
    def __init__(self, google_login, google_password, auth_token, android_id, lang):
    ...
    def login(self, retry=0):
        ...
        while True:
            ...
            try:
                ...
                api.login(self.google_login, self.google_password, self.auth_token)
                return api
...
def main(input_file, out_dir):
    ...
    lang = data[0]['hl']
    gp_login = GPlayLogin(GOOGLE_LOGIN, GOOGLE_PASSWORD, AUTH_TOKEN, ANDROID_ID, lang)
    api = gp_login.login(LOGIN_MAX_TRY_COUNT)
